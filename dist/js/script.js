...
var count_number_OddElements = 0; // кількість парних позитивних елементів
var count_number_Odd_Par_Elements = 0;
var count_number_EvenElements = 0; // кількість непарних позитивних елементів
var count_number_Odd_None_Par_Elements = 0;
var sum_Odd_Positive_Elements = 0; // сума парних позитивних елементів
var sum_Odd_Par_Elements = 0;
var sum_Even_Negative_Elements = 0; // сума непарних позитивних елементів
...
/*
let count_number_Odd_Par_Elements = 0; // кількість парних позитивних елементів
let count_number_Odd_None_Par_Elements = 0; // кількість непарних позитивних елементів
let sum_Odd_Par_Elements = 0; // сума парних позитивних елементів
let sum_Odd_None_Par_elements = 0; // сума непарних позитивних елементів
