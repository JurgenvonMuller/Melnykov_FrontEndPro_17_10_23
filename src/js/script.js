...
let count_Odd_Par_Elements = 0;       // Количество положительных парных элементов
let count_Odd_None_Par_Elements = 0;  // Количество положительных непарных элементов
let sum_Odd_Par_Elements = 0;       //  Сумма положительных парных элементов
let sum_Odd_None_Par_Elements = 0;  //  Сумма положительных непарных элементов
